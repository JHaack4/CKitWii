...
if len(sys.argv) > 1 and sys.argv[1] == "load":
	...
	p.branchlink(0x801c2284, "addTekiBirthCount")
	p.branchlink(0x80197988, "subTekiBirthCount") 
	#p.branchlink(0x80285ecc,"onOtakaraborn")
	#p.branchlink(0x80287730, "onOtakaraborn")
